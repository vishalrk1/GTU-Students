...
class PaperPdfCard extends StatefulWidget {
  final String title;
  final String url;

  PaperPdfCard({required this.title, required this.url});

  @override
  _PaperPdfCardState createState() => _PaperPdfCardState();
}

class _PaperPdfCardState extends State<PaperPdfCard> {
...
// ad loader.....................................................................................
  ...
  void didChangeDependencies() {
    ...
    adState.initialization.then(
      (value) {
        InterstitialAd.load(
          adUnitId: adState.downloadPaperPdfInterstitialAdUnit,
          request: AdRequest(),
          ...
          child: ListTile(
            ...
            trailing: _downloading
                ...
                : RaisedButton(
                    ...
                    onPressed: () async {
                      // download(widget.url, "${widget.title}.pdf");
